#' ---
#' title: "Minimalistic REST API for synthetic transactions"
#' author: ""
#' output: 
#'  github_document
#' ---

#' This REST API offers JSON Web Token authentication for
#' an endpoint that servers up JSON data for transactions
